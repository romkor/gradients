# gradient-publishing Specification

## Purpose
Define the requirements for publishing and unpublishing gradients, controlling their visibility on the home page, restricting access to unpublished gradients to their owners, and ensuring publish records are removed when a gradient is deleted.
